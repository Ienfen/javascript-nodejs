...
NODE_PATH=./handlers:./modules NODE_ENV=test mocha --reporter spec --colors --timeout 100000 --require lib/mongoose --require should --require co --require co-mocha --require ./modules/lib/mongoose --recursive --ui bdd -d $*
