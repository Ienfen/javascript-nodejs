...
Текущая версия: Webpack 2. Особых структурных изменений в ней нет, но много изменений по мелочи, и добавлена "в ядро" поддержка `import`.

В связи с этим в конфиги нужно вносить изменения, чтобы они работали под Webpack 2.
